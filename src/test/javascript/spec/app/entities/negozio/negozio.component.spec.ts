...
import { NegozioComponent } from 'app/entities/negozio/negozio.component';
import { NegozioService } from 'app/entities/negozio/negozio.service';
import { Negozio } from 'app/shared/model/negozio.model';

describe('Component Tests', () => {
    describe('Negozio Management Component', () => {
        let comp: NegozioComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(NegozioComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.negozios[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
