...
public class PrenotazioneResource {
    ...
    @Timed
    public ResponseEntity<List<Prenotazione>> getAllPrenotaziones(Pageable pageable) {
        log.debug("REST request to get a page of Prenotaziones");
        Page<Prenotazione> page = prenotazioneRepository.findAll(pageable);
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/prenotaziones");
